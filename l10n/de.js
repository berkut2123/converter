OC.L10N.register(
    ...
    "converter app not configured. Please contact admin" : "converter App ist nicht konfiguriert. Bitte wenden Sie sich an Ihren Administrator",
    ...
    "converter not reached. Please contact admin" : "converter ist zurzeit nicht erreichbar.  Bitte wenden Sie sich an Ihren Administrator",
    ...
    "Open in converter" : "In converter öffnen",
    "Document" : "Dokument",
    "Spreadsheet" : "Tabelle",
    ...
    "converter Document Service Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "converter Document Servicestandort gibt die Adresse des Servers mit den installierten Dokumentdiensten an. Bitte ändern Sie '<documenterver>' für die Serveradresse in der folgenden Zeile.",
