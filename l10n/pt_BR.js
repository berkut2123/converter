OC.L10N.register(
    ...
    "converter app is not configured. Please contact admin" : "Aplicação converter não está configurada. Favor contatar o administrador",
    ...
    "converter cannot be reached. Please contact admin" : "Não foi possível conectar ao converter. Favor contatar o administrador.",
    ...
    "Open in converter" : "Abrir no converter",
    "Document" : "Documento",
    ...
    "converter Document Service Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "O Endereço do Serviço de Edição de Documentos especifica o servidor onde o serviço de documentos está instalado.\nPor favor mude '<documentserver>' para o endereço do servidor na linha abaixo.",
