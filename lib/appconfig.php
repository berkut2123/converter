...
class AppConfig {
     ...
     */
    public $formats = [
            "docx" => [ "mime" => "application/vnd.openxmlformats-officedocument.wordprocessingml.document", "type" => "text", "conv" => true, "def1" => true ],
            "xlsx" => [ "mime" => "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "type" => "spreadsheet", "conv" => true, "def1" => true ],
            "pptx" => [ "mime" => "application/vnd.openxmlformats-officedocument.presentationml.presentation", "type" => "presentation", "conv" => true, "def1" => true ],
            "ppsx" => [ "mime" => "application/vnd.openxmlformats-officedocument.presentationml.slideshow", "type" => "presentation", "conv" => true, "def1" => true ],
            "txt" => [ "mime" => "text/plain", "type" => "text", "conv" => true ],
            /**"csv" => [ "mime" => "text/csv", "type" => "spreadsheet", "conv" => false ],
            "docm" => [ "mime" => "application/vnd.ms-word.document.macroEnabled.12", "type" => "text", "conv" => false ],
            "xlsm" => [ "mime" => "application/vnd.ms-excel.sheet.macroEnabled.12", "type" => "spreadsheet", "conv" => false ],
            "xltx" => [ "mime" => "application/vnd.openxmlformats-officedocument.spreadsheetml.template", "type" => "spreadsheet", "conv" => false ],
            "xltm" => [ "mime" => "application/vnd.ms-excel.template.macroEnabled.12", "type" => "spreadsheet", "conv" => false ],
            "pptm" => [ "mime" => "application/vnd.ms-powerpoint.presentation.macroEnabled.12", "type" => "presentation", "conv" => false ],
            "ppsm" => [ "mime" => "application/vnd.ms-powerpoint.slideshow.macroEnabled.12", "type" => "presentation", "conv" => false ],
            "potx" => [ "mime" => "application/vnd.openxmlformats-officedocument.presentationml.template", "type" => "presentation", "conv" => false ],
            "potm" => [ "mime" => "application/vnd.ms-powerpoint.template.macroEnabled.12", "type" => "presentation", "conv" => false ],
            ...
            "doc" => [ "mime" => "application/msword", "type" => "text", "conv" => true, "def1" => true  ],
            "xls" => [ "mime" => "application/vnd.ms-excel", "type" => "spreadsheet", "conv" => true, "def1" => true  ],
            "ppt" => [ "mime" => "application/vnd.ms-powerpoint", "type" => "presentation", "conv" => true, "def1" => true  ],
            /**"epub" => [ "mime" => "application/epub+zip", "type" => "text", "conv" => false ],
            "rtf" => [ "mime" => "text/rtf", "type" => "text", "type" => "text", "conv" => false ],
            "mht" => [ "mime" => "message/rfc822", "conv" => false ],
            "html" => [ "mime" => "text/html", "type" => "text", "conv" => false ],
            "htm" => [ "mime" => "text/html", "type" => "text", "conv" => false ],
            "xps" => [ "mime" => "application/vnd.ms-xpsdocument", "type" => "text", "conv" => false ],
            "pdf" => [ "mime" => "application/pdf", "type" => "text", "conv" => false ],
            "djvu" => [ "mime" => "image/vnd.djvu", "type" => "text", "conv" => false ]*/
        ];
}
